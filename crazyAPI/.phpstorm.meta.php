    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Laragear\WebAuthn\Contracts\WebAuthnChallengeRepository' => \Laragear\WebAuthn\Challenge\SessionChallengeRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/uname/Desktop/bigproject/crazyness/CrazyRED/crazyAPI/public/storage' => 'string',
            'horizon.name' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
            ...
            'modules.vapor_maintenance_mode' => 'boolean',
            ...
            'modules.paths.generator.command_replacements.path' => 'string',
            'modules.paths.generator.command_replacements.generate' => 'boolean',
            ...
            'modules.paths.generator.inertia.path' => 'string',
            'modules.paths.generator.inertia.generate' => 'boolean',
            'modules.paths.generator.inertia-components.path' => 'string',
            'modules.paths.generator.inertia-components.generate' => 'boolean',
            ...
            'modules.inertia.frontend' => 'string',
            ...
            'purify.default' => 'string',
            'purify.configs.default.Core.Encoding' => 'string',
            'purify.configs.default.HTML.Doctype' => 'string',
            'purify.configs.default.HTML.Allowed' => 'string',
            'purify.configs.default.HTML.ForbiddenElements' => 'string',
            'purify.configs.default.CSS.AllowedProperties' => 'string',
            'purify.configs.default.AutoFormat.AutoParagraph' => 'boolean',
            'purify.configs.default.AutoFormat.RemoveEmpty' => 'boolean',
            'purify.definitions' => 'string',
            'purify.css-definitions' => 'NULL',
            'purify.serializer.driver' => 'string',
            'purify.serializer.cache' => 'string',
...
'database.redis.horizon.backoff_base','database.redis.horizon.backoff_cap','database.redis.horizon.options.prefix','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.links./home/uname/Desktop/bigproject/crazyness/CrazyRED/crazyAPI/public/storage','horizon.name','horizon.domain','horizon.path','horizon.use',
...
'horizon.watch','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','modules.namespace',
'modules.vapor_maintenance_mode','modules.stubs.enabled','modules.stubs.path','modules.stubs.files.routes/web','modules.stubs.files.routes/api',
...
'modules.paths.generator.command.generate','modules.paths.generator.command_replacements.path','modules.paths.generator.command_replacements.generate','modules.paths.generator.component-class.path','modules.paths.generator.component-class.generate',
...
'modules.paths.generator.views.path','modules.paths.generator.views.generate','modules.paths.generator.inertia.path','modules.paths.generator.inertia.generate','modules.paths.generator.inertia-components.path',
'modules.paths.generator.inertia-components.generate','modules.paths.generator.routes.path','modules.paths.generator.routes.generate','modules.paths.generator.test-feature.path','modules.paths.generator.test-feature.generate',
...
'modules.activator','modules.inertia.frontend','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','reverb.apps.apps.0.accept_client_events_from','reverb.apps.apps.0.rate_limiting.enabled',
'reverb.apps.apps.0.rate_limiting.max_attempts','reverb.apps.apps.0.rate_limiting.decay_seconds','reverb.apps.apps.0.rate_limiting.terminate_on_limit','sanctum.stateful','sanctum.guard',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','webauthn.relying_party.name',
'webauthn.relying_party.id','webauthn.origins','webauthn.challenge.bytes','webauthn.challenge.timeout','webauthn.challenge.key',
'purify.default','purify.configs.default.Core.Encoding','purify.configs.default.HTML.Doctype','purify.configs.default.HTML.Allowed','purify.configs.default.HTML.ForbiddenElements',
'purify.configs.default.CSS.AllowedProperties','purify.configs.default.AutoFormat.AutoParagraph','purify.configs.default.AutoFormat.RemoveEmpty','purify.definitions','purify.css-definitions',
'purify.serializer.driver','purify.serializer.cache','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'horizon.jobs.show','horizon.index','sanctum.csrf-cookie',
'api.thalamus.index','api.thalamus.store','api.thalamus.show','api.thalamus.update','api.thalamus.destroy',
'thalamus.index','thalamus.create','thalamus.store','thalamus.show','thalamus.edit',
'thalamus.update','thalamus.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'thalamus::components.layouts.master','thalamus::index','welcome','horizon::layout','laravel-exceptions-renderer::components.badge',
...
'VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','BROADCAST_CONNECTION','REVERB_APP_ID',
